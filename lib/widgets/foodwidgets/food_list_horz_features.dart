...
import 'package:exam/core/data/featured_food_data.dart';
...
class FoodWidgetFeature extends StatefulWidget {
  const FoodWidgetFeature({Key? key}) : super(key: key);

  @override
  _FoodWidgetFeatureState createState() => _FoodWidgetFeatureState();
}

class _FoodWidgetFeatureState extends State<FoodWidgetFeature> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemCount: FeaturedFoodData.FeaturedFoodList.length,
          itemBuilder: (ctx, i) {
            // FoodModel foods = FoodData.FoodList[i];
            FoodModel foods = FeaturedFoodData.FeaturedFoodList[i];
            return InkWell(
              child: Container(
                  width: getWidth(220),
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (ctx) => DetailsPage(
                              ...
                              food: FeaturedFoodData.FeaturedFoodList[i],
                            )));
              },
            );
          }),
